...
<script>
	$(document).ready(function(){
		...
		$("#inputCode").blur(function(){
    		...
    		if(!codeResult){
				$(".msg3").css({"color":"red", "font-family":"Jua", "font-size":"0.8rem", "padding-top":"1px"});
				$(".msg3").text("7자리 숫자를 입력하세요.");
				$("#inputCode").val("");
				$("#inputCode").focus();
    		} else {
				$(".msg3").css({"color":"dodgerblue", "font-family":"Jua", "font-size":"0.8rem", "padding-top":"1px"});
		...
		////////////////////////////////////////////////////////////////////////////
			...
			$("#reset-password").on("keyup",function(){
				...
				if(!pwResult){
					$(".msg4").css({"color":"red", "font-family":"Jua", "font-size":"0.8rem", "padding-top":"1px"});
			...
			$("#pwChk").on("keyup",function(){
				...
				// 유효성 검사
				if(!pwcheckResult){
					$(".msg5").css({"color":"red", "font-family":"Jua", "font-size":"0.8rem", "padding-top":"1px"});
			...
			$("#reset-password").blur(function(){
				...
				if(pw !="" && pwcheck !=""){
					...
					if(pw == pwcheck){
						$(".msg5").css({"color":"dodgerblue", "font-family":"Jua", "font-size":"0.8rem", "padding-top":"1px"});
