...
<body>	
	<div class="container mainContent" style="padding-bottom:5%;">  
        ...
        <div id="pageHeader">고객센터<span id=toWrite><a href="/class/write"><input type=button id=toWriteBtn value="1:1 문의하기"></a></span><br><hr></div>
        <!-- 가로탭 - 반응형 -->
        <ul class="nav nav-pills nav-justified d-flex d-md-none" id="v-pills-tab2">
            <li class="nav-item">
                <a href="#all-tab"><button class="nav-link" id="v-pills-all-tab2" data-bs-toggle="pill" data-bs-target="#v-pills" type="button" role="tab" aria-controls="v-pills" aria-selected="true"><br>공지사항</button></a>
            </li>
            <li class="nav-item">
                <a href="#cook-tab"><button class="nav-link" id="v-pills-cook-tab2" data-bs-toggle="pill" data-bs-target="#v-pills" type="button" role="tab" aria-controls="v-pills" aria-selected="false"><br>F&Q</button></a>
            </li>
            <li class="nav-item">
                <a href="#music-tab"><button class="nav-link" id="v-pills-music-tab2" data-bs-toggle="pill" data-bs-target="#v-pills" type="button" role="tab" aria-controls="v-pills" aria-selected="false"><br>문의내역</button></a>
            </li>
        </ul>
        ...
        <div class="d-flex align-items-start">
          ...
          <div class="nav flex-column nav-pills me-3 d-none d-md-flex" id="v-pills-tab" role="tablist" aria-orientation="vertical">      
            <a href="#all-tab"><button class="nav-link" id="v-pills-all-tab" data-bs-toggle="pill" data-bs-target="#v-pills" type="button" role="tab" aria-controls="v-pills" aria-selected="true"> 공지사항</button></a>
            <a href="#cook-tab"><button class="nav-link " id="v-pills-cook-tab" data-bs-toggle="pill" data-bs-target="#v-pillsk" type="button" role="tab" aria-controls="v-pills" aria-selected="false"> F&Q</button></a>
            <a href="#music-tab"><button class="nav-link" id="v-pills-music-tab" data-bs-toggle="pill" data-bs-target="#v-pills" type="button" role="tab" aria-controls="v-pills" aria-selected="false"> 문의내역</button></a>
          </div>
