...
<body>
	...
	<div class="modal fade" id="adninMemberOut-toggle" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
			...
			<div class="modal-content memberout-box" align=center>
				<form>
					...
					<div class="modal-header t-auto" style="border-bottom: none; padding-bottom: 0px;"id="login-header">
						<h2>정말 탈퇴 처리하시겠습니까?</h2>
					</div>
					<div class="modal-body">
						<div class="user-box">
							회원 탈퇴 처리 시 회원의 정보 및 결제 내역, 작성 게시글 및 댓글은 모두 삭제됩니다.
						</div>
					</div>
					<div class="modal-footer d-flex" style="border-top: none; display: flex; justify-content: center;">
					<button type="button" id="realOut" class="btns2">탈퇴처리</button>
	...
	<jsp:include page="/WEB-INF/views/admin/adminMemberOutOk.jsp" />

	<script type="text/javascript">
	$("#realOut").on('click',function(){
		$("#adminMemberOutOk-toggle").modal('show');
		$("#adninMemberOut-toggle").modal('hide');
	})
